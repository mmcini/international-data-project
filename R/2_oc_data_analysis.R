...
### [1] "Ca" "Sr" "K"  "Cu" "Zr" "Ti" "Fe" "Mn" "Cr" "Rb" "V"  "Zn"
...
ggarrange(plotlist = visnir_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/visnir_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pls_coefs, aes(x = bands, y = values, color = comps, linetype = comps)) +
       geom_line() + visnir_layout + ylab("Coefficients") +
       ggtitle("Vis-NIR - PLS Coefficients")
ggsave("figures/OC/Brazil/visnir_pls_coefs.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggplot(visnir_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/Brazil/visnir_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = visnir_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/visnir_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/Brazil/visnir_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = visnir_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/visnir_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/Brazil/visnir_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pxrf_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pxrf_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - PLS Variable Importance")
ggsave("figures/OC/Brazil/pxrf_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pxrf_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pxrf_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - Cubist Variable Importance")
ggsave("figures/OC/Brazil/pxrf_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pxrf_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pxrf_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - XGB Variable Importance")
ggsave("figures/OC/Brazil/pxrf_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pv_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pv_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/Brazil/pv_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pv_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pv_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/Brazil/pv_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggarrange(plotlist = pv_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Brazil/pv_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/Brazil/pv_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_pls_plots <- validation_plot(visnir_pls_cv, visnir_pls_valid,
                                    variable = "OC", dataset =  "Vis-NIR", model = "PLS")
ggarrange(plotlist = visnir_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/visnir_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pls_coefs, aes(x = bands, y = values, color = comps, linetype = comps)) +
       geom_line() + visnir_layout + ylab("Coefficients") +
       ggtitle("Vis-NIR - PLS Coefficients")
ggsave("figures/OC/France/visnir_pls_coefs.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggplot(visnir_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/France/visnir_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_cubist_plots <- validation_plot(visnir_cubist_cv, visnir_cubist_valid,
                                       variable = "OC", dataset = "Vis-NIR", model = "Cubist")
ggarrange(plotlist = visnir_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/visnir_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/France/visnir_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_xgb_plots <- validation_plot(visnir_xgb_cv, visnir_xgb_valid,
                                    variable = "OC", dataset = "Vis-NIR", model = "XGB")
ggarrange(plotlist = visnir_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/visnir_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/France/visnir_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_feat_select <- rfe(x = pxrf_data_fr[-c(1, 2)], y = pxrf_data_fr[["OC"]],
                        sizes = c(1:16), rfeControl = control_rfe)
pxrf_selected_predictors <- predictors(pxrf_feat_select)
### [1] "Fe" "Ca" "Rb" "Sr" "As" "Ti" "Cr" "Zn" "V"  "Zr" "Cu" "K"  "Ni" "Ba" "Pb" "Mn"
...
pxrf_pls_plots <- validation_plot(pxrf_pls_cv, pxrf_pls_valid,
                                  variable = "OC", dataset = "PXRF", model = "PLS")
ggarrange(plotlist = pxrf_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pxrf_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - PLS Variable Importance")
ggsave("figures/OC/France/pxrf_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
## Cubist results - kfold cross validation (80%) and hold-out validation (20%)
pxrf_cubist_cv <- pxrf_cubist_model$pred %>%
                  filter(committees == 10, neighbors == 9) %>% # filtering best mode1
                  arrange(rowIndex) %>%
                  add_column(country = pxrf_train_data$country)
pxrf_cubist_valid <- predict(pxrf_cubist_model, newdata = pxrf_valid_data) %>%
                     as_tibble() %>%
...
pxrf_cubist_plots <- validation_plot(pxrf_cubist_cv, pxrf_cubist_valid,
                                     variable = "OC", dataset = "PXRF", model = "Cubist")
ggarrange(plotlist = pxrf_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pxrf_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - Cubist Variable Importance")
ggsave("figures/OC/France/pxrf_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_xgb_plots <- validation_plot(pxrf_xgb_cv, pxrf_xgb_valid,
                                    variable = "OC", dataset = "PXRF", model = "XGB")
ggarrange(plotlist = pxrf_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pxrf_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - XGB Variable Importance")
ggsave("figures/OC/France/pxrf_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_pls_plots <- validation_plot(pv_pls_cv, pv_pls_valid,
                                variable = "OC", dataset = "PXRF + Vis-NIR", model = "PLS")
ggarrange(plotlist = pv_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pv_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/France/pv_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_cubist_plots <- validation_plot(pv_cubist_cv, pv_cubist_valid,
                                   variable = "OC", dataset = "PXRF + Vis-NIR", model = "Cubist")
ggarrange(plotlist = pv_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pv_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/France/pv_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_xgb_plots <- validation_plot(pv_xgb_cv, pv_xgb_valid,
                                variable = "OC", dataset = "PXRF + Vis-NIR", model = "XGB")
ggarrange(plotlist = pv_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/France/pv_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/France/pv_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_pls_plots <- validation_plot(visnir_pls_cv, visnir_pls_valid,
                                    variable = "OC", dataset =  "Vis-NIR", model = "PLS")
ggarrange(plotlist = visnir_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/visnir_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pls_coefs, aes(x = bands, y = values, color = comps, linetype = comps)) +
       geom_line() + visnir_layout + ylab("Coefficients") +
       ggtitle("Vis-NIR - PLS Coefficients")
ggsave("figures/OC/India/visnir_pls_coefs.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggplot(visnir_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/India/visnir_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_cubist_plots <- validation_plot(visnir_cubist_cv, visnir_cubist_valid,
                                       variable = "OC", dataset = "Vis-NIR", model = "Cubist")
ggarrange(plotlist = visnir_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/visnir_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/India/visnir_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
visnir_xgb_plots <- validation_plot(visnir_xgb_cv, visnir_xgb_valid,
                                    variable = "OC", dataset = "Vis-NIR", model = "XGB")
ggarrange(plotlist = visnir_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/visnir_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(visnir_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/India/visnir_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_pls_plots <- validation_plot(pxrf_pls_cv, pxrf_pls_valid,
                                  variable = "OC", dataset = "PXRF", model = "PLS")
ggarrange(plotlist = pxrf_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pxrf_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - PLS Variable Importance")
ggsave("figures/OC/India/pxrf_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_cubist_plots <- validation_plot(pxrf_cubist_cv, pxrf_cubist_valid,
                                     variable = "OC", dataset = "PXRF", model = "Cubist")
ggarrange(plotlist = pxrf_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pxrf_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - Cubist Variable Importance")
ggsave("figures/OC/India/pxrf_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_xgb_plots <- validation_plot(pxrf_xgb_cv, pxrf_xgb_valid,
                                    variable = "OC", dataset = "PXRF", model = "XGB")
ggarrange(plotlist = pxrf_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pxrf_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - XGB Variable Importance")
ggsave("figures/OC/India/pxrf_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_pls_plots <- validation_plot(pv_pls_cv, pv_pls_valid,
                                variable = "OC", dataset = "PXRF + Vis-NIR", model = "PLS")
ggarrange(plotlist = pv_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pv_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - PLS Variable Importance")
ggsave("figures/OC/India/pv_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_cubist_plots <- validation_plot(pv_cubist_cv, pv_cubist_valid,
                                   variable = "OC", dataset = "PXRF + Vis-NIR", model = "Cubist")
ggarrange(plotlist = pv_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pv_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - Cubist Variable Importance")
ggsave("figures/OC/India/pv_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_xgb_plots <- validation_plot(pv_xgb_cv, pv_xgb_valid,
                                variable = "OC", dataset = "PXRF + Vis-NIR", model = "XGB")
ggarrange(plotlist = pv_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/India/pv_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pv_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF + Vis-NIR - XGB Variable Importance")
ggsave("figures/OC/India/pv_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
## PXRF - Africa only has PXRF data
pxrf_data <- raw_data %>%
             select(country, OC, "K":"Pb") %>%
             mutate(across(c("K":"Pb"), ~ replace_na(., 0))) %>% # treat NAs as 0
             drop_na() %>%
...
## PLS results - kfold cross validation (80%) and hold-out validation (20%)
pxrf_pls_cv <- pxrf_pls_model$pred %>%
               filter(ncomp == 1) %>% # best model with comps = 3
               arrange(rowIndex) %>%
               add_column(country = pxrf_train_data$country)
pxrf_pls_valid <- predict(pxrf_pls_model, newdata = pxrf_valid_data) %>%
                  as_tibble() %>%
...
pxrf_pls_plots <- validation_plot(pxrf_pls_cv, pxrf_pls_valid,
                                  variable = "OC", dataset = "PXRF", model = "PLS")
ggarrange(plotlist = pxrf_pls_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Africa/pxrf_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_pls_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - PLS Variable Importance")
ggsave("figures/OC/Africa/pxrf_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_cubist_plots <- validation_plot(pxrf_cubist_cv, pxrf_cubist_valid,
                                     variable = "OC", dataset = "PXRF", model = "Cubist")
ggarrange(plotlist = pxrf_cubist_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Africa/pxrf_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_cubist_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - Cubist Variable Importance")
ggsave("figures/OC/Africa/pxrf_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pxrf_xgb_plots <- validation_plot(pxrf_xgb_cv, pxrf_xgb_valid,
                                    variable = "OC", dataset = "PXRF", model = "XGB")
ggarrange(plotlist = pxrf_xgb_plots, ncol = 2, common.legend = T, legend = "bottom")
ggsave("figures/OC/Africa/pxrf_xgb_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggplot(pxrf_xgb_importance, aes(x = variables, y = Overall)) + importance_plot_layout +
       ggtitle("PXRF - XGB Variable Importance")
ggsave("figures/OC/Africa/pxrf_xgb_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
