...
## Prediction plots
prediction_plot_layout <- list(xlab("Observed Clay (%)"), ylab("Predicted Clay (%)"),
...
raw_clay_data <- read_excel("data/oc_texture_data.xlsx", na = "NA")

## All countries
desc_stats_allcountries <- raw_clay_data %>%
                           select("clay", "K":"Pb") %>%
                           descriptive_stats()
write_excel_csv(desc_stats_allcountries, "tables/clay/descriptive_stats_all_countries.csv")

## By country
desc_stats_bycountries <- raw_clay_data %>%
                          select("country", "clay", "K":"Pb") %>%
                          descriptive_stats(group_by = "country")
write_excel_csv(desc_stats_bycountries, "tables/clay/descriptive_stats_by_country.csv")

## clay plots
ggplot(raw_clay_data, aes(x = clay, fill = country)) +
  geom_histogram() + hist_layout + ggtitle("Clay Data - All Countries")
ggsave("figures/clay/pxrf_oc_histogram.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")

## Boxplots
create_boxplots(raw_clay_data, c("Fe", "Ca", "K"), by_country = F)
create_boxplots(raw_clay_data, c("country","Ti"), by_country = T)
create_boxplots(raw_clay_data, c("country","clay"), by_country = T)

## PXRF plots
pxrf_data <- raw_clay_data %>%
...
ggsave("figures/clay/pxrf_variables_histograms.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")

## Vis-NIR plots
## No continuum removal
visnir_data <- raw_clay_data %>%
...
ggsave("figures/clay/visnir_spectra_all_countries.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")

## With continuum removal
cr_visnir_data <- raw_clay_data %>%
                  select(country, c("350":"2500")) %>%
                  filter(country != "Africa") %>% # Africa has no Vis-NIR data
                  group_by(country) %>%
                  summarise(across(c("350":"2500"), mean, na.rm = T)) %>%
...
ggsave("figures/clay/visnir_cr_spectra_all_countries.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")

## Savitzky-Golay + first derivative
deriv_visnir_data <- raw_clay_data %>%
  select(country, c("350":"2500")) %>%
  filter(country != "Africa") %>% # Africa has no Vis-NIR data
  group_by(country) %>%
  summarise(across(c("350":"2500"), mean, na.rm = T)) %>%
...
ggsave("figures/clay/visnir_deriv_spectra_all_countries.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")

## Correlations
## PXRF correlations
cor_pxrf <- raw_clay_data %>%
            select(clay, c(K:Pb)) %>%
            drop_na() %>%
            cor()
cor_pxrf_pvalue <- raw_clay_data %>%
                   select(clay, c(K:Pb)) %>%
                   drop_na() %>%
                   cor.mtest(conf.level = 0.95) # calculates p-value
png("figures/clay/pxrf_corrplot_all_countries.png", units = "mm", res = 300,
...
corrplot::corrplot(cor_pxrf, method = "color", order = "hclust",
                   ...
                   insig = "label_sig", title = "PXRF vs. clay", mar = c(0, 0, 1.5, 0))
dev.off()

## Vis-NIR correlations
## All countries
cor_visnir_plot_allcountries <- create_cor_visnir(raw_clay_data,
                                                  bands = c(27:242), property = "clay")

## By country
cor_visnir_bycountry <- raw_clay_data %>%
                        filter(country != "Africa") # Africa has no Vis-NIR data
...
ggsave("figures/clay/visnir_corrplot_all_countries.png", dpi = 300, units = "mm",
       width = 200, height = 200, bg = "white")
...
visnir_data_allcountries <- raw_clay_data %>%
...
## Partitioning
set.seed(100)
partition_index <- createDataPartition(visnir_data_allcountries$clay, p = 0.8, list = F)
...
ggsave("figures/clay/visnir_pls_pred_obs.png", dpi = 300, units = "mm",
...
ggsave("figures/clay/visnir_pls_coefs.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/visnir_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/visnir_rf_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/visnir_rf_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/visnir_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/visnir_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
## PXRF models #####################################################################################
pxrf_data_allcountries <- raw_clay_data %>%
                          select(country, clay, "K":"Pb") %>%
...
set.seed(100)
pxrf_feat_select <- rfe(x = pxrf_data_allcountries[-c(1, 2)], y = pxrf_data_allcountries[["clay"]],
...
pxrf_data_allcountries <- pxrf_data_allcountries %>%
                          select(country, clay, predictors(pxrf_feat_select))

## Partitioning
set.seed(100)
partition_index <- createDataPartition(pxrf_data_allcountries$clay, p = 0.8, list = F)
...
ggsave("figures/clay/pxrf_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pxrf_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/pxrf_rf_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pxrf_rf_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/pxrf_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pxrf_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
pv_data_allcountries <- raw_clay_data %>%
...
## Partitioning
set.seed(100)
partition_index <- createDataPartition(pv_data_allcountries$clay, p = 0.8, list = F)
...
ggsave("figures/clay/pv_pls_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pv_pls_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/pv_rf_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pv_rf_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
ggsave("figures/clay/pv_cubist_pred_obs.png", dpi = 300, units = "mm",
       width = 250, height = 150, bg = "white")
...
ggsave("figures/clay/pv_cubist_importance.png", dpi = 300, units = "mm",
       width = 200, height = 150, bg = "white")
...
write_excel_csv(model_scores, "tables/clay/model_scores.csv")
